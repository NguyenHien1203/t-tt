        ...
        RouterModule.forRoot([
            {
                ...
                children: [
                    ...
                    { path: 'ky-so', loadChildren: () => import('./demo/components/ky-so/ky-so.module').then(m => m.KySoModule) },
                    { path: 'nhiem-vu', loadChildren: () => import('./demo/components/nhiem-vu/nhiem-vu.module').then(m => m.NhiemVuModule) },
                    { path: 'thong-ke-nhiem-vu', loadChildren: () => import('./demo/components/thong-ke-nhiem-vu/thong-ke-nhiem-vu.module').then(m => m.ThongKeNhiemVuModule) },
                ]
            },
