...
import { DanhSachDeXuatCongViecRoutingModule } from './danh-sach-de-xuat-cong-viec-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    TabViewModule,
    CommonModule,
    DanhSachDeXuatCongViecRoutingModule,
    FormLayoutDemoRoutingModule
  ]
})
export class DanhSachDeXuatCongViecModule { 
