...
@Component({
  selector: 'app-van-ban-cho-ky-so',
  templateUrl: './van-ban-cho-ky-so.component.html',
  styleUrls: ['./van-ban-cho-ky-so.component.scss'],
  providers: [MessageService]
})
export class VanBanChoKySoComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.breadcrumbItems.push({ label: 'Quản lý văn bản ký số trả lại' });
