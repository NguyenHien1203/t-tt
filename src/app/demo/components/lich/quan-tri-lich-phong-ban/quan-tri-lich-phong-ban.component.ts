...
@Component({
  selector: 'app-quan-tri-lich-phong-ban',
  templateUrl: './quan-tri-lich-phong-ban.component.html',
  styleUrls: ['./quan-tri-lich-phong-ban.component.scss'],
  providers : [ConfirmationService, MessageService, DatePipe]
})
export class QuanTriLichPhongBanComponent {
  constructor(
...
public Xoa(id: string) {
    this.confirmService.confirm({
        ...
        accept: () => {
            this.service.xoaQuanTriLichPhongBan(id).subscribe(
                (data) => {
                    if (data.isError) {
