                ...
                datasets: [
                    {
                        ...
                        label:
                            'Hoàn thành đúng hạn: ' +
                            this.objDataBieuDo?.hoanThanhDungHanCount,
                        backgroundColor:
                    ...
                    },
                    {
                        type: 'bar',
                        label:
                            'Đang hoàn thành đúng hạn: ' +
                            this.objDataBieuDo?.dangHoanThanhDungHanCount,
                        backgroundColor:
                    ...
                    },
                    {
                        ...
                        label:
                            'Hoàn thành quá hạn: ' +
                            this.objDataBieuDo?.hoanThanhQuaHanCount,
                        backgroundColor:
                    ...
                    },
                    {
                        type: 'bar',
                        label:
                            'Đang hoàn thành quá hạn: ' +
                            this.objDataBieuDo?.dangHoanThanhQuaHanCount,
                        backgroundColor:
