...
import { TimKiemDanhSach, XemThongBao } from 'src/app/models/thong-tin-khac/xem-thong-bao';
...
userId = this.authService.GetmUserInfo()?.userId;
  ...
  public LoadDanhSach(): void {
    ...
    this.service.getDanhSachXemThongBao(this.timKiemDanhSach).then(data => { this.xemThongBaos = data;})
  }
