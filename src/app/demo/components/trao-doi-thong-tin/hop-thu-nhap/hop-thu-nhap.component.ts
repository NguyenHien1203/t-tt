...
import { HopThuNhapService } from 'src/app/demo/service/trao-doi-thong-tin/hop-thu-nhap.service';
...
@Component({
    selector: 'app-hop-thu-nhap',
    templateUrl: './hop-thu-nhap.component.html',
    styleUrls: ['./hop-thu-nhap.component.scss'],
    providers: [MessageService, ConfirmationService],
})
export class HopThuNhapComponent {
    constructor(
        private messageService: MessageService,
        private service: HopThuNhapService,
    ...
    items = [{ label: 'Trao đổi thông tin' }, { label: 'Hộp thư nháp' }];
    ...
    public LoadDanhSach() {
        ...
        this.service.getDanhSachHopThuNhap(this.timKiemDanhSach).then((data) => {
