...
@Component({
  selector: 'app-sua-van-ban',
  templateUrl: './sua-van-ban.component.html',
  styleUrls: ['./sua-van-ban.component.scss']
})
export class SuaVanBanComponent {
  @Input() id: string = '1';
  ...
  vanBanDi: any = [];
  file: File | null = null;
  chkLuuTru: boolean = false;
  chkCoQuan: boolean = false;
  ...
  public async BindDialogData() {
      try {
          ...
          this.formThongTinVanBan.patchValue({
              ...
              chkVanBanLuuTru: this.chkLuuTru,
              chkTatCaCQ: this.chkCoQuan,
  ...
  public CheckVanBanLuuTru(): void {
      this.chkLuuTru = !this.chkLuuTru;
  }

  public CheckTatCaCQ(): void {
      this.chkCoQuan = !this.chkCoQuan;
  }
  ...
  public ReturnTrangChu() {
      this.router.navigate(['/van-ban-den/quan-tri-van-ban']);
  }
}
