...
@Component({
  selector: 'app-them-lich',
  templateUrl: './them-lich.component.html',
  styleUrls: ['./them-lich.component.scss']
})
export class ThemLichComponent {
  ...
  public ThemMoi(): void {
      ...
      if (this.formThemMoi.valid) {
          ...
          quanTriLich.id = 0;
          this.service.themMoiLichCoQuan(quanTriLich).subscribe(
              (data) => {
                  if (data.isError) {
