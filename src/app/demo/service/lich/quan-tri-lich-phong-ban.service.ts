...
getDanhSachQuanTriLichPhongBan(timKiemDanhSach: TimKiemQuanTriLichPhongBan) {
    return this.http
        .post<any>(
...
capNhatQuanTriLichPhongBan(itemData: any) {
    return this.http.post<any>(
        environment.baseUrlApi + '/Lich/QuanTriLichPhongBan/CapNhatQuanTriLichPhongBan',
        itemData,
        this.httpOption
    );
}
...
themMoiQuanTriLichPhongBan(itemData: any) {
    return this.http.post<any>(
        environment.baseUrlApi + '/Lich/QuanTriLichPhongBan/ThemMoiQuanTriLichPhongBan',
        itemData,
        this.httpOption
    );
}
